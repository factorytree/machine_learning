...
def get_X(data,pointnum=100,layernum=7):
    if data=='naive':
        ...
        filepath='../classification/layer_{}'.format(layernum)
...
if __name__ == "__main__":
    ...
    y=get_label('../classification/layer_{}_label.txt'.format(layernum))
    newX = tsne(X, 2, 10, 20.0,2)
    from matplotlib import pyplot as plt
    plt.scatter(newX[:,0], newX[:,1], 20, y)
    plt.show()